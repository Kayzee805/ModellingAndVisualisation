...
plt.title("immune vs infection for 50x50")
plt.savefig("figures/immune50.png")
plt.show()
...
combined=np.array((pImmune,finalArray,errors))
np.savetxt('data/task5Part2ProcessedData.dat',np.transpose(combined),fmt='%.6f')
np.savetxt('data/task5Part2RawData.dat',np.transpose(combined),fmt='%.6f')
...
plt.savefig("figures/immune100.png")
plt.show()
